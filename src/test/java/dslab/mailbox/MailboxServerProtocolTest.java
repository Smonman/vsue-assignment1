...
public class MailboxServerProtocolTest extends TestBase {
    ...
    private static final Log LOG =
        LogFactory.getLog(MailboxServerProtocolTest.class);
    ...
    public void setUp() throws Exception {
        ...
        Sockets.waitForSocket("localhost", dmapServerPort,
            Constants.COMPONENT_STARTUP_WAIT);
        Sockets.waitForSocket("localhost", dmtpServerPort,
            Constants.COMPONENT_STARTUP_WAIT);
    }
    ...
    public void loginAndLogout_withValidLogin() throws Exception {
        try (JunitSocketClient client = new JunitSocketClient(dmapServerPort,
            err)) {
    ...
    public void acceptDmtpMessage_listDmapMessage() throws Exception {
        ...
        try (JunitSocketClient client = new JunitSocketClient(dmapServerPort,
            ...
            err.checkThat(listResult,
                containsString("arthur@earth.planet hello"));
    ...
    @Test(timeout = 15000)
    public void dmtpMessage_withUnknownRecipient_returnsError()
        throws Exception {
