...
public class TransferServerProtocolTest extends TestBase {
    ...
    private static final Log LOG =
        LogFactory.getLog(TransferServerProtocolTest.class);
    ...
    public void setUp() throws Exception {
        ...
        Sockets.waitForSocket("localhost", serverPort,
    ...
    public void defaultDmtpInteractionTest() throws Exception {
        try (
            JunitSocketClient client = new JunitSocketClient(serverPort, err)) {
