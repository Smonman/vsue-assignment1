...
public class TransferServerTest extends TestBase {
    ...
    public void runAndShutdownTransferServer_createsAndStopsTcpSocketCorrectly()
        throws Exception {
        ITransferServer component =
            ComponentFactory.createTransferServer("transfer-1", in, out);
        ...
        try {
            ...
            err.addError(new AssertionError(
                "Expected a TCP server socket on port " + port, e));
        }
        ...
        err.checkThat("Expected tcp socket on port " + port +
